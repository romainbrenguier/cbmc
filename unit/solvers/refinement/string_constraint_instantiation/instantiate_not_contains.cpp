...
char_array_exprt make_string_exprt(const std::string &str)
{
  ...
  return char_array_exprt(length, content, t.string_type());
}
...
std::set<exprt> full_index_set(const char_array_exprt &s)
{

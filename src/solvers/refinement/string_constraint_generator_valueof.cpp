  ...
  const exprt &i, size_t max_size, const refined_string_typet &ref_type)
{
  ...
  and_exprt correct_length1(res.axiom_for_is_strictly_longer_than(1),
  ...
  and_exprt correct_length2(res.axiom_for_is_strictly_longer_than(0),

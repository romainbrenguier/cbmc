/// \file
/// Generates string constraints corresponding to the
/// Java SimpleDateFormat.format function
...
class string_constraint_generatort::date_format_specifiert
{
public:
  ...
  static const char WEEK_OF_YEAR              ='w';
  static const char WEEK_OF_MONTH         ='W';
  static const char DAY_OF_YEAR                  ='D';
  static const char DAY_OF_MONTH            ='d';
  static const char DAY_OF_WEEK_IN_MONTH            ='F';
  static const char DAY_NAME_IN_WEEK        ='E';
  static const char DAY_NUMEER_OF_WEEK  ='u';
  static const char AM_PM_MARKER                ='a';
  static const char HOUR_INDAY          ='H';
  /// TO FININSH
  static const char DATE_TIME                ='k';
  static const char DATE_TIME_UPPER          ='K';
  static const char BOOLEAN                  ='h';
  static const char BOOLEAN_UPPER            ='m';
  static const char STRING                   ='s';
  static const char STRING_UPPER             ='S';
  static const char HASHCODE                 ='z';
  static const char HASHCODE_UPPER           ='Z';
  static const char LINE_SEPARATOR           ='X';

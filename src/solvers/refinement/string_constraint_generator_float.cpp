  ...
  const function_application_exprt &f)
{
  ...
  char_array_exprt res=char_array_of_string_expr(string_exprt(
    f.arguments()[0],
    f.arguments()[1],
...
///   raised
exprt string_constraint_generatort::add_axioms_for_string_of_float(
  const char_array_exprt &res, const exprt &f, const refined_string_typet &ref_type)
{
  ...
  char_array_exprt fractional_part_str=
...
char_array_exprt string_constraint_generatort::add_axioms_for_fractional_part(
    ...
    const char_array_exprt &res, const exprt &f, const refined_string_typet &ref_type)
{
  ...
  char_array_exprt string_fractional_part=add_axioms_for_fractional_part(

  ...
  const char_array_exprt &res, const exprt &f)
{
  ...
  const char_array_exprt fractional_part_str=
  ...
  const mod_exprt integer_part(round_expr_to_zero(f), max_non_exponent_notation);
  // We should not need more than 8 characters to represent the integer
  // part of the float.
  const char_array_exprt integer_part_str=
    fresh_string(index_type, char_type);
...
exprt string_constraint_generatort::add_axioms_for_fractional_part(
  const char_array_exprt &res, const exprt &int_expr, size_t max_size)
{
    ...
    const char_array_exprt &res, const exprt &f)
{
  ...
  char_array_exprt string_fractional_part=
    fresh_string(index_type, char_type);
  ...
  const char_array_exprt string_expr_with_fractional_part=
    fresh_string(index_type, char_type);
  ...
  const char_array_exprt stringE=fresh_string(index_type, char_type);
  const exprt return_code4=add_axioms_for_constant(stringE, "E");
  const char_array_exprt string_expr_with_E=fresh_string(index_type, char_type);
  ...
  const char_array_exprt exponent_string=fresh_string(index_type, char_type);

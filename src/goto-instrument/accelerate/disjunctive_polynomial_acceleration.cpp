  ...
  guard_managert &guard_manager)
{
      ...
      ++it)
  {
    ...
    if(path_acceleration.fit_polynomial(
      assigns,
      target,
      poly,
      guard_manager))
  ...
  try
  {
    path_is_monotone= utils.do_assumptions(
      polynomials,
      path,
      guard,
      guard_manager);
 ...
 * will be doing later.
 */
void disjunctive_polynomial_accelerationt::build_fixed(guard_managert &guard_manager)
{
